...
\acro{urls}[URLs]{Uniform Resource Locators}
...
\captionof{figure}{Features als Pfade dargestellt \parencite{Cohen2016}}\label{fig:features}
\end{center}
...
NSL-KDD       & 2009          & Netzwerkverkehr (\textgreater{}12 Protokolle)                                                                           & 41                & $\sim$290 GB    & \begin{tabular}[c]{@{}l@{}}DoS, Probe,\\  U2R, R2L,\\normal\end{tabular}                                                                                          \\ \hline
