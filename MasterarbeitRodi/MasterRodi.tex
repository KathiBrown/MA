...
\begin{itemize}
\item Twitter drive-by Downloads:\\durch verschleierte Links können Angreifer Zugriff auf die Systeme der Opfer und somit auf deren Daten erlangen.
\item Probe:\\Untersuchung der Netzwerke potenzieller Opfer durch Port-Scans beispielsweise. Dabei werden offene Ports gesucht, über welche mit dem Zielnetz kommuniziert werden könnte.
\item SQL Injections:\\Bösartige SQL Abfragen können dem Angreifer Zugriff auf Benutzerdaten bis hin zu Datenbanken geben.
\item macrobasierte Attacken
\end{itemize}
