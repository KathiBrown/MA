...
Wie zu Beginn des Kapitels erläutert, sollen die Datensätze miteinander verglichen werden um eine Aussage über deren jeweilige Qualität treffen zu könne. Hierzu wurden die Attribute: Jahr, Größe bzw Umfang, Inhalt, Labels und Features untersucht. Das Jahr soll die Aktualität eines Datensets widerspiegeln. Da die Genauigkeit von \ac{mlas} abhängig von der Größe und Diversität ihres zugrunde liegenden Trainingssets sind, ist ein umso größeres Datenset von Vorteil, weshalb auch der Aspekt der Größe als auch der des Inhalts betrachtet wird. Ein bereits gelabeltes Datenset erspart Data Scientist viel Zeit und somit Arbeit und verstärkt somit die positive Bewertung eines Datensets. Eine genaue Beschreibung der Features und eine große Anzahl ist dahingehend von Vorteil, dass dadurch Feature Engineering betrieben werden kann, was zu einer deutlichen Verbesserung der Ergebnisse führen kann.
Nachfolgende Tabelle \ref{tab:datensets} gibt einen Überblick über die Ergebnisse der Datenset Analyse.
\begin{table}[H]
\hspace{-2.8cm}
\begin{tabular}{llllll}
\hline
\textbf{Name} & \textbf{Jahr} & \textbf{Inhalt}                                                                                                         & \textbf{Features} & \textbf{Umfang}                                                                & \textbf{Label}                                                                                                                                           \\ \hline
HTTP CSIC     & 2010          & HTTP Web Anfragen                                                                                                       & 13                & \begin{tabular}[c]{@{}l@{}}61.000\\ ($\sim$60 MB)\end{tabular}                 & \begin{tabular}[c]{@{}l@{}}normal/\\ anomal\end{tabular}                                                                                                 \\ \hline
NSL-KDD       & 2009          & Netzwerkverkehr (\textgreater{}12 Protokolle)                                                                           & 41                & \begin{tabular}[c]{@{}l@{}}\textgreater{}160.000\\ ($\sim$290 GB)\end{tabular} & \begin{tabular}[c]{@{}l@{}}DoS, Probe,\\  U2R, R2L\end{tabular}                                                                                          \\ \hline
LANL          & 2015          & \begin{tabular}[c]{@{}l@{}}Authentifizierung, Prozesse,\\ DNS Suchanfragen, Netzwerkdaten, \\ Red Team Events\end{tabular} & 30                & \begin{tabular}[c]{@{}l@{}}\textgreater{}1Mrd\\ ($\sim$270GB)\end{tabular}     & Red Team                                                                                                                                                 \\ \hline
ISCX          & 2010          & Netzwerkverkehr (6 Protokolle)                                                                                          & 19                & \begin{tabular}[c]{@{}l@{}}2.5 Mio\\ ($\sim$85 GB)\end{tabular}                & \begin{tabular}[c]{@{}l@{}}normal/\\ angriff\end{tabular}                                                                                                \\ \hline
CTU-13        & 2014          & Netzwerkverkehr (10 Protokolle)                                                                                         & n. b.             & $\sim$697 GB                                                                   & \begin{tabular}[c]{@{}l@{}}Hintergrund, Botnet,\\ C\&C, normal\end{tabular}                                                                              \\ \hline
MMCC          & 2015          & .byte Dateien                                                                                                           & n. b.             & $\sim$500GB                                                                    & \begin{tabular}[c]{@{}l@{}}Ramnit, Lollipop, \\ Kelihos\_ver3, \\ Vundo, \\ Simda, \\ Tracur, \\ Kelihos\_ver1, \\ Obfuscator.ACY, \\ Gatak\end{tabular} \\ \hline
CICIDS        & 2017          & Netzwerkverkehr (6 Protokolle)                                                                                          & 80                & $\sim$50GB                                                                     & \begin{tabular}[c]{@{}l@{}}normal/\\ anomal\end{tabular}                                                                                                 \\ \hline
CIC           & 2017          & Netzwerkverkehr                                                                                                         & n. b.             & $\sim$46 GB                                                                    & -                                                                                                                                                        \\ \hline
ASNM-NPBO     & 2016          & TCP Kommunikation                                                                                                       & $\sim$900         & 7.000                                                                          & \begin{tabular}[c]{@{}l@{}}normal/anomal\\ (inkl. Verschleierungs-\\ technik)\end{tabular}                                                               \\ \hline
CERT          & 2013          & Synthetische Insiderbedrohungen                                                                                         & 23                & $\sim$85 GB                                                                    & -                                                                                                                                                        \\ \hline
EMBER         & 2018          & PE Dateien                                                                                                              & 48                & 1.1 Mio                                                                        & \begin{tabular}[c]{@{}l@{}}gutartig, bösartig, \\ ungelabelt\end{tabular}                                                                                \\ \hline
\end{tabular}
