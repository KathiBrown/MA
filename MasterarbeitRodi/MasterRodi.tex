...
In diesem Kapitel wird die Forschungsmethode erläutert auf welcher der Informationsgewinn basiert und wodurch neue Erkenntnisse gewonnen werden konnten.\\\\
...
Im folgenden Kapitel werden Begrifflichkeiten definiert und erläutert, welche eine hohe Relevanz für die Erstellung dieser Arbeit beinhalten und somit zu einem besseren und einheitlichen Verständnis der Thematik führen sollen.
\section{IOC - Bösartiges Verhalten}
\label{sec:ioc}
%
\section{CRISP-DM}
\label{sec:crisp}
